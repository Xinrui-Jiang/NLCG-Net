...
ref_data = torch.load(r"/root/autodl-tmp/MOBA-T2mapping-master/dataset/reconstructed_img.pth")[:,:,selected_list].cuda()
...
def imgNRMSE(result,ref_img,mask):
    ...
    num = img.shape[-1]
    #te_list = [0.023,0.069,0.115,0.161,0.207,0.253,0.299,0.345]
    te_list = [0.023,0.046,0.069,0.092,0.115,0.138,0.161,0.184]
