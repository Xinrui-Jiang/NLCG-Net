...
class encoder_block(nn.Module):
    def __init__(self, filter_size,is_instance_norm,activation_type,padding_type='same'):
        ...
        self.conv_block1 = conv_block(filter_size,padding_type,is_instance_norm,activation_type)
        self.conv_block2 = conv_block(block2_filter_size,'same',is_instance_norm,activation_type)
...
class decoder_block(nn.Module):
    def __init__(self, kernel_size,in_c,out_c,is_instance_norm,activation_type,padding_type='same'):
        ...
        self.conv_block1 = conv_block((kernel_size,in_c,out_c),'same',is_instance_norm,activation_type)
        self.conv_block2 = conv_block((kernel_size,out_c,out_c),padding_type,is_instance_norm,activation_type)
...
class U_net(nn.Module):
    def __init__(self,in_ch=3):
        ...
        self.encoder_block1 = encoder_block(filter1,is_instance_norm=True,activation_type='LeakyReLU',padding_type=(1,2))
        ...
        self.decoder_block3 = decoder_block(kernel_size,64,32,is_instance_norm=True,activation_type='LeakyReLU',padding_type=(1,0))
        ...
        scaling_factor[:,2] = scaling_factor[:,2] * 6.
